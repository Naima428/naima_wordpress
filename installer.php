...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221208_voyage_4849d16a3e6efae75037_20221208151710_archive.zip';
        const ARCHIVE_SIZE       = '48111565';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '4849d16-08151710';
        const SECONDARY_PACKAGE_HASH = 'fad8988-08151710';
        const VERSION            = '1.5.1';
